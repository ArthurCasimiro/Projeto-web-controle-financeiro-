...
def criar_gasto(valor, data, categoria_id, usuario_id):
    gasto = Gasto(valor=valor, data=data, categoria_id=categoria_id, usuario_id=usuario_id)
...
def atualizar_gasto(gasto_id, valor=None, data=None, categoria_id=None):
